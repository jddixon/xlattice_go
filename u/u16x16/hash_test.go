...
// xlattice_go/u/u16x16/hash_test.go
...
func (s *XLSuite) doTestExists(c *C, u *U16x16, digest hash.Hash) {
...
func (s *XLSuite) doTestFileLen(c *C, u *U16x16, digest hash.Hash) {
...
func (s *XLSuite) doTestFileHash(c *C, u *U16x16, digest hash.Hash) {
...
func (s *XLSuite) doTestGetPathForKey(c *C, u *U16x16, digest hash.Hash) {
	...
	expectedPath := fmt.Sprintf("%s/%s/%s/%s",
		u.path, uKey[0:1], uKey[1:2], uKey[2:])
	c.Assert(expectedPath, Equals, kPath)
}

func (s *XLSuite) doTestPut(c *C, u *U16x16, digest hash.Hash) {
...
func (s *XLSuite) doTestPutData(c *C, u *U16x16, digest hash.Hash) {
